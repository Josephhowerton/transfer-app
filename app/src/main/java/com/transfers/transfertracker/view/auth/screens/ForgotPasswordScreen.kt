...
@Composable
fun ForgotPasswordScreen(viewModel: AuthViewModel, onErrorAction: () -> Unit) = TransferTrackerTheme {

    var emailField by remember { mutableStateOf("") }
    Scaffold(topBar = {

        TransferTopAppBar(stringResource(id = R.string.action_forgot_password), false, onErrorAction)
        ...
        ConstraintLayout(modifier = Modifier.fillMaxSize()) {
            ...
            OutlinedTextField(
                value = emailField,
                label = { Text("Email") },
                onValueChange = { emailField = AuthFormat.removeWhitespace(it) },
